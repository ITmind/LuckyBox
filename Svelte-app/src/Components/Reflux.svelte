<script>
    ...
    // function reflux_add_sensor() {
    //     sendRequest("refluxSensorsSetLoad", {},  selectSensorsReflus, error);
    // };
...
<div class="container tab-pane theme_grey swipe-tab-content active">
    <div class="row">
        <div id="error_reflux" class="col-md-offset-2 col-md-8" />
    </div>
    <div class="row">
                    ...
                    <div class="form-group pt-10 clearfix" id="reflux_algorithm">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <select class="form-control noSwipe" id="reflux_algorithm_select" />
                            </div>
                        </div>
                    </div>
                    <Volume bind:volume={reflux_volume} />
                </div>

                <div class="col-xs-12">
                    <div class="bg-info noSwipe" id="view_reflux_chart" />
                </div>
            </div>
        </div>
    </div>
